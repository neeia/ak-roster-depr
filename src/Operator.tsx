...
function Operator(props: OperatorProps) {
    const { name, rarity, potential, promotion, level, skillLevel, skill1Mastery, skill2Mastery, skill3Mastery } = props;
    let whatever = name;
    ...
    const imgUrl = `https://res.cloudinary.com/samidare/image/upload/v1/arknights/operators/${slugify(whatever, { lower: true, replacement: "-"})}`;
    ...
    return(
        <div className="collection">
            ...
            <div className="data-row">
                <div className = "field"><img src={potentialUrl} className="icon" alt={`Potential ${potential} icon`} /></div>
                <div className = "field"><img src={promotionUrl} className="icon" alt={`Elite ${promotion} icon`} /></div>
                <div className = "field"><div className = "level-icon"> {level}</div></div>
            </div>
            {(skillLevel < 7 ?
            <div className="data-row">
